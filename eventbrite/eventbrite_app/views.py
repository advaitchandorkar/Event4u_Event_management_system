...
def pdf_generator(event_name,event_date,cname,branch,erp,students,participants,volunteer,subEventsList,budget):
    ...
    pdf = SimpleDocTemplate("C://Users//sayal//Documents//Suraj Sahani//eventbrite//eventbrite//eventbrite_app//static//eventreport.pdf", pagesize=letter)
    ...
    story = []
    logo = Image("C://Users//sayal//Documents//Suraj Sahani//eventbrite//eventbrite//eventbrite_app//ltcoe.png", width=2*inch, height=2*inch)  # Replace "logo.png" with your logo file name
    story.append(logo)
